...
@pytest.mark.django_db
def test_chart_agricultural_land(api_client, create_token) -> None:
...
@pytest.mark.django_db
def test_total_area(api_client, create_token) -> None:
...
@pytest.mark.django_db
def test_total_farm(api_client, create_token) -> None:
